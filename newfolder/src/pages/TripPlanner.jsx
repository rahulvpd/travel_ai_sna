                            ...
                            >
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-black/20 border border-white/20 rounded-xl p-5 text-2xl text-center text-white placeholder:text-white/20 focus:border-vibrant-gold outline-none"
                                        value={preferences.destination}
                                        onChange={(e) => setPreferences({ ...preferences, destination: e.target.value })}
                                        onKeyDown={(e) => e.key === 'Enter' && preferences.destination && nextStep()}
                                        autoFocus
                                    />
                                ...
                                <div className="text-center">
                                    <button
                                        ...
                                        className="px-8 py-3 bg-white text-black font-bold rounded-full hover:bg-vibrant-gold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        Next
                                    </button>
                                </div>
