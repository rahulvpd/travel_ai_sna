                ...
                <div className="relative z-10 container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <motion.h1
                            ...
                            className="font-heading text-6xl md:text-8xl font-bold text-white mb-8 leading-tight drop-shadow-2xl text-shadow-lg"
                        >
                            TAMIL <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-vibrant-gold to-vibrant-pink">NADU</span>
                        </motion.h1>
