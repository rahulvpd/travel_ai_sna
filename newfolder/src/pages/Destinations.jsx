                            ...
                            >
                                ...
                                <div className="absolute inset-x-0 bottom-0 p-8 z-10 flex flex-col justify-end h-full">
                                    ...
                                    <div className="transform transition-transform duration-500 group-hover:-translate-y-4">
                                        ...
                                        <Link to={`/destinations/${dest.id}`} className="inline-flex items-center gap-2 text-vibrant-gold font-bold text-sm tracking-widest uppercase hover:gap-4 transition-all">
