...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative bg-bg-dark overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1625624773824-3431633512e0?q=80&w=2670&auto=format&fit=crop')] bg-cover bg-center opacity-20" />
            ...
            >
                <div className="text-center mb-10">
                    <h2 className="font-heading text-4xl font-bold text-white mb-2 text-glow-gold">Begin Journey</h2>
                    <p className="text-white/60">Create your traveler profile.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/40 group-focus-within:text-vibrant-gold transition-colors" />
                            <input
                                type="text"
                                value={name}
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        type="submit"
                        className="w-full bg-gradient-to-r from-vibrant-gold to-vibrant-orange text-black font-bold py-4 rounded-xl shadow-[0_0_20px_rgba(255,204,0,0.3)] hover:shadow-[0_0_30px_rgba(255,204,0,0.5)] transition-all flex items-center justify-center gap-2 group"
                    >
                        Create Account
                ...
                <div className="mt-8 text-center">
                    <p className="text-white/60">
                        ...
                        <Link to="/login" className="text-vibrant-gold hover:text-white transition-colors font-medium hover:underline decoration-vibrant-gold/50 underline-offset-4">
                            Sign In
                        </Link>
                    </p>
                </div>
